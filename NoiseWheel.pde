...
{  
    ...
    drawMetaDataForWheel();
}

void drawMetaDataForWheel()
{
  textSize(15);
  ...
  String sWheelType[] = { "Hourly", "Daily", "Weekly", "Monthly", "Yearly"};
  String line_1 = "Wheel Type: " + sWheelType[wheelType].toUpperCase();
